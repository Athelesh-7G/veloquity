export const MOCK_EVIDENCE = [
  {
    ...
    representativeItems: [
      ...
      { id: 'ev001-r02', source: 'Zendesk' as const, text: 'Mobile performance has gotten significantly worse since the last update', date: '2026-03-09' },
      ...
      { id: 'ev001-r05', source: 'Zendesk' as const, text: '50 mobile users reporting slow load times since the March release. Not a network issue.', date: '2026-03-06' },
      ...
      { id: 'ev001-r07', source: 'Zendesk' as const, text: 'Mobile load time increased from 2s to 12s after latest release. Confirmed on 3 devices.', date: '2026-03-04' },
      ...
      { id: 'ev001-r09', source: 'Zendesk' as const, text: 'iPhone users experiencing 10+ second loads on main screen since the update.', date: '2026-03-02' },
  ...
  },
  {
    ...
    representativeItems: [
      ...
      { id: 'ev002-r02', source: 'Zendesk' as const, text: 'Dark mode is the most requested feature in our team survey by far', date: '2026-03-09' },
      ...
      { id: 'ev002-r05', source: 'Zendesk' as const, text: 'Dark mode would reduce eye strain for our night shift operators significantly', date: '2026-03-06' },
      ...
      { id: 'ev002-r07', source: 'Zendesk' as const, text: '120 users voted for dark mode in our internal survey. Top-requested feature.', date: '2026-03-04' },
      ...
      { id: 'ev002-r10', source: 'Zendesk' as const, text: 'Our entire team uses the app in a dimly lit environment. Dark mode is essential.', date: '2026-03-01' },
    ],
    status: "active",
  ...
  },
  {
    ...
    representativeItems: [
      { id: 'ev003-r01', source: 'Zendesk' as const, text: 'CSV export fails silently when date range exceeds 30 days', date: '2026-03-10' },
      { id: 'ev003-r02', source: 'Zendesk' as const, text: 'Export button does nothing on Firefox. Works on Chrome only.', date: '2026-03-09' },
      { id: 'ev003-r03', source: 'Zendesk' as const, text: 'Lost 2 hours of work because export corrupted my data completely', date: '2026-03-08' },
      { id: 'ev003-r04', source: 'Zendesk' as const, text: 'Success toast shown but downloaded file is always 0 bytes', date: '2026-03-07' },
      ...
      { id: 'ev003-r06', source: 'Zendesk' as const, text: 'Export silently fails for datasets over 5000 rows with no notification at all', date: '2026-03-05' },
      ...
      { id: 'ev003-r08', source: 'Zendesk' as const, text: 'Data export has been unreliable for 3 weeks. Blocking our entire reporting pipeline.', date: '2026-03-03' },
      ...
      { id: 'ev003-r10', source: 'Zendesk' as const, text: 'Large dataset export always fails silently. An email fallback would help greatly.', date: '2026-03-01' },
    ],
    status: "active",
  ...
  },
  {
    ...
    representativeItems: [
      { id: 'ev004-r01', source: 'Zendesk' as const, text: 'Our security team requires SSO before we can expand our license', date: '2026-03-10' },
      { id: 'ev004-r02', source: 'Zendesk' as const, text: 'SAML integration is blocking our enterprise rollout completely', date: '2026-03-09' },
      { id: 'ev004-r03', source: 'Zendesk' as const, text: 'Okta support is non-negotiable for our security compliance requirements', date: '2026-03-08' },
      { id: 'ev004-r04', source: 'Zendesk' as const, text: 'We cannot deploy to 500 more users without enterprise SSO support', date: '2026-03-07' },
      { id: 'ev004-r05', source: 'Zendesk' as const, text: 'Azure AD integration required for our IT policy. Blocking all expansion.', date: '2026-03-06' },
      { id: 'ev004-r06', source: 'Zendesk' as const, text: 'SSO is the only blocker for our $80k enterprise license renewal', date: '2026-03-05' },
      ...
      { id: 'ev004-r08', source: 'Zendesk' as const, text: 'Security team rejected our license expansion request due to missing SSO support', date: '2026-03-03' },
      { id: 'ev004-r09', source: 'Zendesk' as const, text: 'SCIM provisioning plus SAML SSO are required for our enterprise compliance', date: '2026-03-02' },
      { id: 'ev004-r10', source: 'Zendesk' as const, text: 'Without SSO we cannot manage user access at scale. This is a hard blocker.', date: '2026-03-01' },
    ],
    status: "active",
...
export interface FeedbackDataItem {
  id: string
  source: 'appstore' | 'zendesk' | 'patient_portal' | 'hospital_survey'
  text: string
  date: string
  rating?: number
  cluster: string
...
export const APP_PRODUCT_ITEMS: FeedbackDataItem[] = [
  // ── Cluster: App crashes on project switch (15 appstore, 15 zendesk) ────────
  ...
  { id: 'ap016', source: 'zendesk', date: '2026-03-11', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4821', priority: 'high' }, text: 'Critical: crash on project context switch. Reproducible every time. Full crash log attached. Please escalate.' },
  { id: 'ap017', source: 'zendesk', date: '2026-03-10', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4819', priority: 'high' }, text: 'Our entire enterprise account is affected by the project switch crash introduced in v2.4.' },
  { id: 'ap018', source: 'zendesk', date: '2026-03-09', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4815', priority: 'high' }, text: 'All 15 members of our team cannot switch projects without crashing. Attaching null pointer trace.' },
  { id: 'ap019', source: 'zendesk', date: '2026-03-08', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4811', priority: 'high' }, text: 'Project switch crash regression from v2.4. Was stable in v2.3.1. Need this hotfixed this week.' },
  { id: 'ap020', source: 'zendesk', date: '2026-03-07', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4807', priority: 'high' }, text: 'The project context is not being flushed before navigation. Race condition. Happy to share full logs.' },
  { id: 'ap021', source: 'zendesk', date: '2026-03-06', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4803', priority: 'high' }, text: 'This crash has cost our team 3 hours of re-entry work this week. Blocking daily standups.' },
  { id: 'ap022', source: 'zendesk', date: '2026-03-05', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4799', priority: 'high' }, text: 'Multiple enterprise clients are affected by the project switch crash. Need an urgent patch.' },
  { id: 'ap023', source: 'zendesk', date: '2026-03-04', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4796', priority: 'high' }, text: 'iOS 17.4 + project switch = guaranteed crash. Reproducible in 2 steps. Attaching device logs.' },
  { id: 'ap024', source: 'zendesk', date: '2026-03-03', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4791', priority: 'high' }, text: 'Escalating: project switch crash affecting all users on latest iOS. 12 tickets from one account alone.' },
  { id: 'ap025', source: 'zendesk', date: '2026-03-01', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4785', priority: 'high' }, text: 'Null pointer on project context load. Same device, same steps, every time. This is a complete regression.' },
  { id: 'ap026', source: 'zendesk', date: '2026-02-28', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4779', priority: 'high' }, text: 'Filed 10 days ago. Still no patch. Our team cannot do cross-project work until this is resolved.' },
  { id: 'ap027', source: 'zendesk', date: '2026-02-26', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4773', priority: 'high' }, text: 'The cold switch crash is 100% reproducible. Warm switch (stay in project) is unaffected. Context load issue.' },
  { id: 'ap028', source: 'zendesk', date: '2026-02-24', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4768', priority: 'high' }, text: 'We traced the crash to the project context handler. Null pointer on project B load when context A is still active.' },
  { id: 'ap029', source: 'zendesk', date: '2026-02-22', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4763', priority: 'high' }, text: 'Crash introduced in v2.4 exactly. Branch comparison confirms the regression source. Please fix urgently.' },
  { id: 'ap030', source: 'zendesk', date: '2026-02-20', cluster: 'App crashes on project switch', metadata: { ticket: 'ZD-4758', priority: 'high' }, text: 'Our CTO has escalated this to your enterprise support. 50 users cannot use multi-project workflows.' },

  // ── Cluster: Black screen after latest update (10 appstore, 10 zendesk) ─────
  ...
  { id: 'ap041', source: 'zendesk', date: '2026-02-17', cluster: 'Black screen after latest update', metadata: { ticket: 'ZD-4751', priority: 'high' }, text: '12 users on our account all reporting black screen on cold start since the 2.4 update.' },
  { id: 'ap042', source: 'zendesk', date: '2026-02-15', cluster: 'Black screen after latest update', metadata: { ticket: 'ZD-4747', priority: 'high' }, text: 'Black screen on launch — suspected async init deadlock. Warm restart resolves. Cold start always affected.' },
  { id: 'ap043', source: 'zendesk', date: '2026-02-13', cluster: 'Black screen after latest update', metadata: { ticket: 'ZD-4743', priority: 'medium' }, text: 'All users on iOS 17 are reporting black screen on their first daily launch of the app since 2.4.' },
  { id: 'ap044', source: 'zendesk', date: '2026-02-11', cluster: 'Black screen after latest update', metadata: { ticket: 'ZD-4739', priority: 'high' }, text: 'The black screen issue correlates exactly with the 2.4 release timestamp. Was fine in 2.3.1.' },
  { id: 'ap045', source: 'zendesk', date: '2026-02-09', cluster: 'Black screen after latest update', metadata: { ticket: 'ZD-4735', priority: 'high' }, text: 'Cold start deadlock introduced in 2.4. Confirmed on iPhone 13, 14, and iPad Pro universally.' },
  { id: 'ap046', source: 'zendesk', date: '2026-02-07', cluster: 'Black screen after latest update', metadata: { ticket: 'ZD-4731', priority: 'medium' }, text: 'Enterprise team cannot reliably use the app first thing in the morning due to black screen on cold start.' },
  { id: 'ap047', source: 'zendesk', date: '2026-02-05', cluster: 'Black screen after latest update', metadata: { ticket: 'ZD-4727', priority: 'high' }, text: 'The fix for the black screen should be the top priority — it impacts every user on their first interaction.' },
  { id: 'ap048', source: 'zendesk', date: '2026-02-03', cluster: 'Black screen after latest update', metadata: { ticket: 'ZD-4723', priority: 'medium' }, text: 'Black screen duration varies 10-30 seconds per device. Sometimes crashes instead of loading correctly.' },
  { id: 'ap049', source: 'zendesk', date: '2026-02-01', cluster: 'Black screen after latest update', metadata: { ticket: 'ZD-4719', priority: 'high' }, text: '50 users affected by the black screen cold start. This is impacting our entire company daily.' },
  { id: 'ap050', source: 'zendesk', date: '2026-01-29', cluster: 'Black screen after latest update', metadata: { ticket: 'ZD-4715', priority: 'medium' }, text: 'Background refresh is on, battery optimization is off. Still black screen on cold start every day.' },

  // ── Cluster: Dashboard load regression (10 appstore, 10 zendesk) ─────────────
  ...
  { id: 'ap061', source: 'zendesk', date: '2026-01-27', cluster: 'Dashboard load regression', metadata: { ticket: 'ZD-4711', priority: 'high' }, text: 'Enterprise workspace with 200+ projects: dashboard now takes 15 seconds to load. Blocking daily standups.' },
  { id: 'ap062', source: 'zendesk', date: '2026-01-25', cluster: 'Dashboard load regression', metadata: { ticket: 'ZD-4707', priority: 'high' }, text: 'Dashboard load regression measured precisely: 2.1s before v2.4, 12.4s after. Not a network issue.' },
  { id: 'ap063', source: 'zendesk', date: '2026-01-23', cluster: 'Dashboard load regression', metadata: { ticket: 'ZD-4703', priority: 'high' }, text: 'Our team standups are blocked by 12+ second dashboard loads. This is affecting our SLA metrics.' },
  { id: 'ap064', source: 'zendesk', date: '2026-01-21', cluster: 'Dashboard load regression', metadata: { ticket: 'ZD-4699', priority: 'medium' }, text: 'Dashboard performance scales badly with project count after v2.4. 250 projects = 15s load time.' },
  { id: 'ap065', source: 'zendesk', date: '2026-01-19', cluster: 'Dashboard load regression', metadata: { ticket: 'ZD-4695', priority: 'medium' }, text: 'Render cycle seems to have changed — widgets now fetch sequentially instead of in parallel in 2.4.' },
  { id: 'ap066', source: 'zendesk', date: '2026-01-17', cluster: 'Dashboard load regression', metadata: { ticket: 'ZD-4691', priority: 'high' }, text: 'Performance regression confirmed on 3 separate devices and 2 network connections. Not environment-specific.' },
  { id: 'ap067', source: 'zendesk', date: '2026-01-15', cluster: 'Dashboard load regression', metadata: { ticket: 'ZD-4687', priority: 'medium' }, text: 'Dashboard went from acceptable to unusable for power users with large workspaces after v2.4.' },
  { id: 'ap068', source: 'zendesk', date: '2026-01-13', cluster: 'Dashboard load regression', metadata: { ticket: 'ZD-4683', priority: 'high' }, text: 'Frontend profiling shows redundant re-renders in the dashboard component post-2.4. Clear regression.' },
  { id: 'ap069', source: 'zendesk', date: '2026-01-11', cluster: 'Dashboard load regression', metadata: { ticket: 'ZD-4679', priority: 'medium' }, text: 'The dashboard load regression is affecting our enterprise SLA. Clients are complaining.' },
  { id: 'ap070', source: 'zendesk', date: '2026-01-09', cluster: 'Dashboard load regression', metadata: { ticket: 'ZD-4675', priority: 'high' }, text: 'Dashboard loads 6x slower since v2.4. This is not acceptable for an enterprise-grade productivity tool.' },

  // ── Cluster: No onboarding checklist (8 appstore, 7 zendesk) ─────────────────
  ...
  { id: 'ap079', source: 'zendesk', date: '2025-12-15', cluster: 'No onboarding checklist', metadata: { ticket: 'ZD-4671', priority: 'medium' }, text: 'Every new team member needs a 30-minute walkthrough from an existing user. No in-app onboarding exists.' },
  { id: 'ap080', source: 'zendesk', date: '2025-11-25', cluster: 'No onboarding checklist', metadata: { ticket: 'ZD-4667', priority: 'medium' }, text: 'We lose at least 1 hour per new hire due to the missing onboarding flow. Feature request: checklist.' },
  { id: 'ap081', source: 'zendesk', date: '2025-11-15', cluster: 'No onboarding checklist', metadata: { ticket: 'ZD-4663', priority: 'medium' }, text: 'Requesting onboarding checklist feature. High priority for our rapidly growing team.' },
  { id: 'ap082', source: 'zendesk', date: '2025-11-05', cluster: 'No onboarding checklist', metadata: { ticket: 'ZD-4659', priority: 'low' }, text: 'New user activation rate is low because there is no guidance after signup. Please add a welcome flow.' },
  { id: 'ap083', source: 'zendesk', date: '2025-10-25', cluster: 'No onboarding checklist', metadata: { ticket: 'ZD-4655', priority: 'medium' }, text: 'Our CS team receives the same 3 onboarding questions from every new user. In-app checklist would fix this.' },
  { id: 'ap084', source: 'zendesk', date: '2025-10-15', cluster: 'No onboarding checklist', metadata: { ticket: 'ZD-4651', priority: 'low' }, text: 'All major competitors have onboarding checklists. This is a significant UX gap in our product.' },
  { id: 'ap085', source: 'zendesk', date: '2025-10-05', cluster: 'No onboarding checklist', metadata: { ticket: 'ZD-4647', priority: 'medium' }, text: 'Please add a dismissible getting started checklist overlay for first-time users. Simple and high impact.' },

  // ── Cluster: Export to CSV silently fails (5 appstore, 5 zendesk) ─────────────
  ...
  { id: 'ap091', source: 'zendesk', date: '2025-11-30', cluster: 'Export to CSV silently fails', metadata: { ticket: 'ZD-4643', priority: 'high' }, text: 'Export works for small datasets but silently fails for our 5000+ row reports. No error, no email.' },
  { id: 'ap092', source: 'zendesk', date: '2025-11-15', cluster: 'Export to CSV silently fails', metadata: { ticket: 'ZD-4639', priority: 'high' }, text: 'CSV export success toast but empty file every time. This is blocking our entire weekly reporting process.' },
  { id: 'ap093', source: 'zendesk', date: '2025-11-01', cluster: 'Export to CSV silently fails', metadata: { ticket: 'ZD-4635', priority: 'high' }, text: 'Silent export failure on large datasets — no error message, no email fallback, nothing at all.' },
  { id: 'ap094', source: 'zendesk', date: '2025-10-15', cluster: 'Export to CSV silently fails', metadata: { ticket: 'ZD-4631', priority: 'medium' }, text: 'Export button completely non-functional on Firefox. Works on Chrome. Inconsistent behavior.' },
  { id: 'ap095', source: 'zendesk', date: '2025-10-01', cluster: 'Export to CSV silently fails', metadata: { ticket: 'ZD-4627', priority: 'high' }, text: 'Data export has been broken since the latest release. Blocking our entire analytics reporting pipeline.' },
