...
import { hasUploadedData, getActiveDataset, SOURCE_LABELS } from '@/utils/uploadState'
...
export default function EvidenceGrid() {
  ...
  const filteredList = evidenceList
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid sm:grid-cols-4 gap-4 mb-8">
        {[
          {
            icon: Shield,       label: 'Evidence Clusters',  value: hasData ? filteredList.length : 0,
