...
const APP_INITIAL_METRICS: ConfidenceMetric[] = [
  {
    ...
    priorityScore: 87,
    factors: ['Cross-source corroboration (App Store + Support Tickets)', 'High unique user count (94)', 'Regression introduced in v2.4', 'Null pointer reproducible in crash logs'],
        ...
        <CardContent className="text-sm text-muted-foreground space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              { w: '0.20', label: 'Source corroboration',note: '+0.1 if both App Store + Support Tickets'     },
