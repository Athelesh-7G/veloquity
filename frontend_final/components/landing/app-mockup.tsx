      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl border border-black/10 dark:border-white/10 shadow-2xl overflow-hidden">
        ...
        <div className="flex min-h-[400px]">
          ...
          <div className="flex-1 p-6">
            ...
            {/* Evidence lines connecting to roadmap */}
            <div className="relative mt-6">
              <svg className="absolute inset-0 w-full h-20 pointer-events-none" style={{ overflow: "visible" }}>
                <motion.path
                  d="M 100 0 Q 150 40, 200 60"
              ...
              {/* Roadmap item with confidence gauge */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="flex justify-between mt-1">
                    <span className="text-[10px] text-black/40 dark:text-white/40">75%</span>
                    <span className="text-[10px] text-black/40 dark:text-white/40">92%</span>
                  </div>
                  <p className="text-[10px] text-black/40 dark:text-white/40 text-center mt-1">
                    Uncertainty range based on 47 evidence items
                  </p>
                </div>
              </motion.div>
            </div>
