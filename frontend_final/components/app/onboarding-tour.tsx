...
const tourSteps = [
  {
    icon: Sparkles,
    title: "Welcome to Veloquity",
    description:
      "Your evidence-grounded decision support system. Let's take a quick tour of the key features that will help you reason over messy feedback.",
  ...
  },
  {
    ...
    title: "Data Studio",
    description:
      "Import and manage feedback from any source. Search, filter, and organize signals while maintaining full traceability to their origins.",
  ...
  },
  {
    ...
    title: "Evidence Grid",
    description:
      "See how feedback clusters into evidence with explicit confidence scores and uncertainty ranges. Never hide complexity behind a single number.",
  ...
  },
  {
    ...
    description:
      "Explore scenarios by adjusting thresholds. Understand how different confidence levels affect your roadmap priorities.",
